	...
	<table width="90%" border ='1' cellpadding='0' cellspacing='0' >
      ...
      while($blockRow=mysqli_fetch_object($blockListRes)){
       ...
       while($blockRow1=mysqli_fetch_object($blockListRes1)){
         ...
         $blockListOfIcdQu="SELECT DISTINCT block_cpa AS block FROM ctmsmis.yard_block
         WHERE terminal IN ('NOFCY','OFY') AND  block_cpa!='NULL' ORDER BY block ASC";


         
         $blockListForScNofcyRes=mysqli_query($con_sparcsn4,$blockListOfIcdQu);
        ...
        ELSE 1 END) AS yard_tot
        FROM xps_che 
        WHERE  xps_che.short_name LIKE 'MHC%'
        )  tbl
        GROUP BY yard";
       ...
       while(($rtn_rmg_cct=oci_fetch_object($row_rmg_cct))!=false)
		{
			 $rmg_cct_tot=$rtn_rmg_cct->TOT_RMG_CCT_BOOKED;
               ...
               $rmg_nct="SELECT count(distinct equipement) AS tot_rmg_nct_booked
                 ...
                 FROM xps_che 
                 INNER JOIN xps_chezone ON xps_chezone.che_id=xps_che.id 
                 WHERE short_name IS NOT NULL AND short_name!='' AND short_name NOT LIKE 'HHT%' AND short_name NOT LIKE 'F%' AND short_name NOT LIKE 'SP%' AND sel_block IN($blockListNct)
                 )  tbl 
                  WHERE sel_block IS NOT NULL ORDER BY equipement
        ...
        FROM xps_che 
        INNER JOIN xps_chezone ON xps_chezone.che_id=xps_che.id 
        WHERE short_name IS NOT NULL AND short_name!='' AND short_name NOT LIKE 'HHT%' AND short_name NOT LIKE 'F%' AND short_name NOT LIKE 'SP%' AND sel_block IN($blockListIcd)
        )  tbl 
        WHERE sel_block IS NOT NULL ORDER BY equipement
        )  t1 WHERE tbl.equipement LIKE 'RMG%'";
        ...
        while(($rtn_sc_icd=oci_fetch_object($row_sc_icd))!=false)
		{
         ...
         $sc_nct="
        SELECT COUNT(DISTINCT short_name) AS nct_sc 
        FROM xps_che
        INNER JOIN xps_chezone ON xps_chezone.che_id=xps_che.id  
       ...
       while(($rtn_flt42_nofcy=oci_fetch_object($row_flt42_nofcy))!=false)
        ...
        FROM xps_che 
        INNER JOIN xps_chezone ON xps_chezone.che_id=xps_che.id 
        WHERE short_name IS NOT NULL AND short_name!='' AND short_name NOT LIKE 'HHT%' AND short_name NOT LIKE 'SP%' AND sel_block IN($blockList)
        ) tbl 
        WHERE sel_block IS NOT NULL ORDER BY equipement
      ...
      $block_strChkShareJrSc_qu="SELECT DISTINCT block AS block FROM ctmsmis.yard_block
      WHERE  block_cpa!='NULL' AND block_cpa !='JR' ORDER BY block ASC";
 
      $block_strChkShareJrSc_Res=mysqli_query($con_sparcsn4,$block_strChkShareJrSc_qu);
...
// block for SCY end
            ...
            <td>
                <?php
                 //block for 'Y6','Y6X' start
              $block_Y8B_qu="SELECT DISTINCT block AS block FROM ctmsmis.yard_block
              WHERE  block_cpa!='NULL' AND  block_cpa !='YARD 8' ORDER BY block ASC";

              $block_Y8B_Res=mysqli_query($con_sparcsn4,$block_Y8B_qu);
              $totalRow_Y8B=mysqli_num_rows($block_Y8B_Res);

             $ab9=0;
             $blockList_Y8B_NotIn="";
             while($blockRow_Y8B=mysqli_fetch_object($block_Y8B_Res)){

                $blockString_Y8B="";
                
                $blockString_Y8B=$blockRow_Y8B->block;
                
                if($ab9==($totalRow_Y8B-1)){
                $blockList_Y8B_NotIn=$blockList_Y8B_NotIn."'".$blockString_Y8B."'";           
                }
                else{
                $blockList_Y8B_NotIn=$blockList_Y8B_NotIn."'".$blockString_Y8B."',";
                }
               ...
               // block for Y6 or Y6X end
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('YARD 8') ORDER BY 1";
                ...
                while($rowABSC = mysqli_fetch_object($resABSC)){
                    ...
                    if(!$inarr)
                    {
                        ...
                        oci_execute($resCSAS);
                        $results10=array();
                          $numRowCSAS = oci_fetch_all($resCSAS, $results10, null, null, OCI_FETCHSTATEMENT_BY_ROW);
                        oci_free_statement($resCSAS); 
                        $resCSAS= oci_parse($con_sparcsn4_oracle,$strChkShareABSc);
                        oci_execute($resCSAS);
                        if($numRowCSAS>0)
            ...
            <td>
              ...
              $block_BX2_Y8_BAPX1_BX1_qu="SELECT DISTINCT block AS block FROM ctmsmis.yard_block
              WHERE  block_cpa!='NULL' AND  block_cpa NOT IN('YARD 8','BAPEX') ORDER BY block ASC";
            ...
            <td>
              ...
              $block_Y9_Y10_qu="SELECT DISTINCT block AS block FROM ctmsmis.yard_block
              WHERE  block_cpa!='NULL' AND  block_cpa NOT IN('YARD 9','YARD-10') ORDER BY block ASC";

              $block_Y9_Y10_Res=mysqli_query($con_sparcsn4,$block_Y9_Y10_qu);
              $totalRow_Y9_Y10=mysqli_num_rows($block_Y9_Y10_Res);

             $ab11=0;
             $blockList_Y9_Y10_NotIn="";
             while($blockRow_Y9_Y10=mysqli_fetch_object($block_Y9_Y10_Res)){

                $blockString_Y9_Y10="";
                
                $blockString_Y9_Y10=$blockRow_Y9_Y10->block;
                
                if($ab11==($totalRow_Y9_Y10-1)){
                $blockList_Y9_Y10_NotIn=$blockList_Y9_Y10_NotIn."'".$blockString_Y9_Y10."'";           
                }
                else{
                $blockList_Y9_Y10_NotIn=$blockList_Y9_Y10_NotIn."'".$blockString_Y9_Y10."',";
                }
                $ab11++;
                 ...
                 $blockList_Y9_Y10_NotIn;
                 //Get All block but not in 'Y9','Y10' End

                $strABSC = "SELECT DISTINCT equipment
				FROM ctmsmis.mis_equip_assign_detail
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('YARD 9','YARD-10') ORDER BY 1";
                $resABSC = mysqli_query($con_sparcsn4,$strABSC);
                $nValAB = 0;
                $plusValAB = 0;
                $numRowCSAS = 0;
                ...
                while($rowABSC = mysqli_fetch_object($resABSC)){
                    ...
                    WHERE short_name = '$equiABSc' AND sel_block IN($blockList_Y9_Y10_NotIn)
                       ...
                       oci_execute($resCSAS);
                       $results12=array();
                       $numRowCSAS = oci_fetch_all($resCSAS, $results12, null, null, OCI_FETCHSTATEMENT_BY_ROW);
                       oci_free_statement($resCSAS); 
                       $resCSAS= oci_parse($con_sparcsn4_oracle,$strChkShareABSc);
                       oci_execute($resCSAS);
                        if($numRowCSAS>0)
      ...
      //Get All block but not in 'AB' End
        ...
        <tr align="center">
            ...
            <td>
                ...
                while($rowJRSC = mysqli_fetch_object($resJRSC)){
                   ...
                   oci_execute($resCSJS);
                   $results44=array();
                   $numRowCSAS = oci_fetch_all($resCSJS, $results44, null, null, OCI_FETCHSTATEMENT_BY_ROW);
                   oci_free_statement($resCSJS); 
                   $resCSJS= oci_parse($con_sparcsn4_oracle,$strChkShareJrSc);
                   oci_execute($resCSJS);
                    if($numRowCSJS>0)
            ...
            <td>
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'FLT%' AND capacity=16 AND block_cpa='AB ZONE' ORDER BY 1";
                $resABSC = mysqli_query($con_sparcsn4,$strABSC);
                $nValAB = 0;
                $plusValAB = 0;
                $numRowCSAS = 0;
                ...
                while($rowABSC = mysqli_fetch_object($resABSC)){
                    ...
                    if(!$inarr)
                    {
                       ...
                       oci_execute($resCSAS);
                       $results45=array();
                       $numRowCSAS = oci_fetch_all($resCSAS, $results45, null, null, OCI_FETCHSTATEMENT_BY_ROW);
                       oci_free_statement($resCSAS); 
                       $resCSAS= oci_parse($con_sparcsn4_oracle,$strChkShareABSc);
                       oci_execute($resCSAS);
                        if($numRowCSAS>0)
            ...
            <td>
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'FLT%' AND capacity=16 AND block_cpa in('YARD-1','YARD 2','MN YARD') ORDER BY 1";
                $resABSC = mysqli_query($con_sparcsn4,$strABSC);
                $nValAB = 0;
                $plusValAB = 0;
                $block_cpa= "";
                ...
                while($rowABSC = mysqli_fetch_object($resABSC)){
                    ...
                    if(!$inarr)
                    {
                       ...
                       oci_execute($resCSAS);
                       $results49=array();
                       $numRowCSAS = oci_fetch_all($resCSAS, $results49, null, null, OCI_FETCHSTATEMENT_BY_ROW);
                       oci_free_statement($resCSAS); 
                       $resCSAS= oci_parse($con_sparcsn4_oracle,$strChkShareABSc);
                       oci_execute($resCSAS);
                        if($numRowCSAS>0)
            ...
            <td>
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'FLT%' AND capacity=16 AND block_cpa in('YARD 05') ORDER BY 1";
                $resABSC = mysqli_query($con_sparcsn4,$strABSC);
                $nValAB = 0;
                $plusValAB = 0;
                $numRowCSAS = 0;
                ...
                while($rowABSC = mysqli_fetch_object($resABSC)){
                    ...
                    if(!$inarr)
                    {
                        ...
                        oci_execute($resCSAS);
                        $results51=array();
                        $numRowCSAS = oci_fetch_all($resCSAS, $results51, null, null, OCI_FETCHSTATEMENT_BY_ROW);
                        oci_free_statement($resCSAS); 
                        $resCSAS= oci_parse($con_sparcsn4_oracle,$strChkShareABSc);
                        oci_execute($resCSAS);
                        if($numRowCSAS>0)
		...
		<table width="90%" border ='1' cellpadding='0' cellspacing='0' >
			...
			<tr align="center">			
				...
				<td>
					<?php 
						$rtg_out_of_order = $rtg_ab_out+$rtg_c_out+($rtg_d_tot-($rtg_d_booked+$rtg_d_standby)); 
						echo $rtg_ab_out+$rtg_c_out+($rtg_d_tot-($rtg_d_booked+$rtg_d_standby));  
					?>
				</td>
