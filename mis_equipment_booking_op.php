	...
	<body>
		<div>
			...
			<div align="center">
				...
				<form action="mis_equipment_booking_op_prePDF.php" method="POST" target="_blank">
					<table>					
						<br/>
						<tr style="margin:5px;">
        ...
        <table width="90%" border ='0' cellpadding='0' cellspacing='0'>	
			<caption><font size="5"><b>Daily Equipment Booking operator for the Date of <?php echo $date; ?></b></font></caption>
		<tr>
