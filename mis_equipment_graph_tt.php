		...
		<div>
			...
			<div align="center">
				...
				<?php
					...
					DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
					...
					(
					SELECT 
					(SELECT suply FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RTG') AS suply,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT out_of_order FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RTG') AS out_of_order,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT stand_by FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RTG') AS stand_by,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT demand FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RMG') AS demand,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT suply FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RMG') AS suply,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT out_of_order FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RMG') AS out_of_order,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT stand_by FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RMG') AS stand_by,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT demand FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='SC') AS demand,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT suply FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='SC') AS suply,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT out_of_order FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='SC') AS out_of_order,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT stand_by FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='SC') AS stand_by,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT demand FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RST 45 Ton') AS demand,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT suply FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RST 45 Ton') AS suply,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT out_of_order FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RST 45 Ton') AS out_of_order,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT stand_by FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RST 45 Ton') AS stand_by,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT demand FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 42 Ton') AS demand,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT suply FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 42 Ton') AS suply,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT out_of_order FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 42 Ton') AS out_of_order,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT stand_by FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 42 Ton') AS stand_by,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT demand FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 10 Ton') AS demand,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT suply FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 10 Ton') AS suply,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT out_of_order FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 10 Ton') AS out_of_order,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT stand_by FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 10 Ton') AS stand_by,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT demand FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 16 Ton') AS demand,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT suply FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 16 Ton') AS suply,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT out_of_order FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 16 Ton') AS out_of_order,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT stand_by FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='FLT 16 Ton') AS stand_by,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT demand FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RST 7 Ton') AS demand,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT suply FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RST 7 Ton') AS suply,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT out_of_order FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RST 7 Ton') AS out_of_order,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT stand_by FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='RST 7 Ton') AS stand_by,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT demand FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='CM') AS demand,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT suply FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='CM') AS suply,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT out_of_order FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='CM') AS out_of_order,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
					...
					(
					SELECT 
					(SELECT stand_by FROM ctmsmis.mis_equip_demand_suply WHERE DATE(demand_suply_date)=DATE(mytable.dt) AND equipment_type='CM') AS stand_by,DATE_FORMAT(dt, '%Y,%m,%d') AS graph_day
					FROM (
						SELECT CONCAT(YEAR(NOW()),'-',MONTH(NOW()),'-01') + INTERVAL a + b DAY dt
						FROM
						(SELECT 0 a UNION SELECT 1 a UNION SELECT 2 UNION SELECT 3
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		...
		[
			...
			?>
			//alert(<?php echo $i."==".$numRows; ?>);
			{ x: new Date(<?php echo $row->graph_year.",".$row->graph_month.",".$row->graph_date ;?>), y: <?php echo $row->demand;?> },
			<?php
			}
			else
			{
	...
	},
	{
		...
		[
			...
			{ x: new Date(<?php echo $rowSup->graph_year.",".$rowSup->graph_month.",".$rowSup->graph_date ;?>), y: <?php echo $rowSup->suply;?> },
			<?php
			}
			else
			{
	...
	},
	{
		...
		[
			...
			{ x: new Date(<?php echo $rowStand->graph_year.",".$rowStand->graph_month.",".$rowStand->graph_date ;?>), y: <?php echo $rowStand->stand_by;?> },
			<?php
			}
			else
			{
	...
	},
	{
		...
		[
			...
			{ x: new Date(<?php echo $rowOut->graph_year.",".$rowOut->graph_month.",".$rowOut->graph_date ;?>), y: <?php echo $rowOut->out_of_order;?> },
			<?php
			}
			else
			{
