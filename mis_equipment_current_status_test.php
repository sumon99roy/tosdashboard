...
<html>
	...
	<?php
		...
		$qgc_query="SELECT yard,if(yard='NCT',SUM(yard_tot),SUM(yard_tot)) AS tot FROM (
		SELECT 
	...
	//	$rtn_qgc_query=mysql_fetch_object($row_qgc_query);
		...
		INNER JOIN sparcsn4.xps_chezone ON sparcsn4.xps_chezone.che_id=sparcsn4.xps_che.id  
		INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=sel_block
		WHERE short_name LIKE 'RST7%' AND yard_block.block IN ('CSE','CSF')";
		$row_rst7_icd=mysql_query($rst7_icd);
		$rtn_rst7_icd=mysql_fetch_object($row_rst7_icd);
		...
		INNER JOIN sparcsn4.xps_chezone ON sparcsn4.xps_chezone.che_id=sparcsn4.xps_che.id  
		INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=sel_block
		WHERE short_name LIKE 'RST7%' and yard_block.terminal='NCT'";
		$row_rst7_nct=mysql_query($rst7_nct);
		$rtn_rst7_nct=mysql_fetch_object($row_rst7_nct);
		$rst7_nct_tot=$rtn_flt42_nct->nct_rst7;
		
		$rst7_nofcy="SELECT COUNT(DISTINCT short_name) AS nofcy_rst7
		FROM sparcsn4.xps_che
		INNER JOIN sparcsn4.xps_chezone ON sparcsn4.xps_chezone.che_id=sparcsn4.xps_che.id  
		INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=sel_block
		WHERE short_name LIKE 'RST7%' AND yard_block.terminal IN ('NOFCY')";
		$row_rst7_nofcy=mysql_query($rst7_nofcy);
		$rtn_rst7_nofcy=mysql_fetch_object($row_rst7_nofcy);
		...
		WHERE short_name IS NOT NULL AND short_name!='' AND short_name NOT LIKE 'HHT%' AND short_name NOT LIKE 'SP%') AS tbl 
		WHERE yard IS NOT NULL ORDER BY equipement
		) AS t1 WHERE sl=1 AND equipement LIKE 'RST7%' AND block NOT IN ('CSE','CSF')";

		$row_rst7_cct=mysql_query($rst7_cct);
		$rtn_rst7_cct=mysql_fetch_object($row_rst7_cct);
		$rst7_cct_tot=$rtn_flt42_cct->tot_rst7_cct_booked;
	...
	<tr align="center">			
		...
		<td><?php if($qgc_nct_tot!=0) echo $qgc_nct_tot."__"; ?></td>
		<td><?php echo $icdDeVal; ?></td>
		<td><?php echo $nofcyDeVal; ?></td>
	...
	<tr align="center">			
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa='AB' ORDER BY 1";
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa='DREFFER' ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$block_cpa="";
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa='Y7' ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
			...
			<?php 
				...
				while($rowABSC = mysql_fetch_object($resABSC)){
					...
					if(!$inarr)
					{
						...
						INNER JOIN sparcsn4.xps_chezone ON sparcsn4.xps_chezone.che_id=sparcsn4.xps_che.id
						INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=sel_block
						WHERE short_name = '$equiABSc') AS tbl WHERE block_cpa !='SCY'";
						$resCSAS = mysql_query($strChkShareABSc);
						$numRowCSAS = mysql_num_rows($resCSAS);
						if($numRowCSAS>0)
						{
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('Y1','Y2','YMN') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$block_cpa="";
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('Y3') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('Y5') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('Y6','Y6X') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('Y8B') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('BAPX1','BAPX2','Y8') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('Y9','Y10') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'RTG%' AND block_cpa in('Y11') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td><?php echo $icdDeVal; ?></td>
		<td><?php echo $nofcyDeVal; ?></td>
		<td><?php echo $tot_rtg_booked+$tot_equip_rtg; ?></td>
			...
			<?php 
				...
				while($rowABSC = mysql_fetch_object($resABSC)){
					...
					if(!$inarr)
					{
						...
						INNER JOIN sparcsn4.xps_chezone ON sparcsn4.xps_chezone.che_id=sparcsn4.xps_che.id
						INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=sel_block
						WHERE short_name = '$equiABSc') AS tbl WHERE block_cpa NOT IN('SCY')";
						$resCSAS = mysql_query($strChkShareABSc);
						$numRowCSAS = mysql_num_rows($resCSAS);
						if($numRowCSAS>0)
						{
	...
	<tr align="center">
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa='AB' ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa='DREFFER' ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$block_cpa = "";
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa='Y7' ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa in('Y1','Y2','YMN') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$block_cpa = "";
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa in('Y3') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa in('Y5') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa in('Y6','Y6X') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<!--td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa in('Y8') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa in('Y8B') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa in('BAPX1','BAPX2','Y8') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa in('Y9','Y10') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
		...
		<td>
			<?php 
				...
				INNER JOIN ctmsmis.mis_equip_detail ON mis_equip_assign_detail.equip_detail_id=mis_equip_detail.id
				INNER JOIN ctmsmis.yard_block ON ctmsmis.yard_block.block=ctmsmis.mis_equip_assign_detail.block
				WHERE start_state =1 AND end_state=0 AND DATE(start_work_time)=DATE(NOW()) AND equipment LIKE 'CM%' AND capacity=50 AND block_cpa in('Y11') ORDER BY 1";
				$resABSC = mysql_query($strABSC);
				$nValAB = 0;
				$plusValAB = 0;
				$numRowCSAS = 0;
	...
	<?php //} ?>
		...
		<table width="90%" border ='1' cellpadding='0' cellspacing='0' >
			...
			<tr align="center">						
				...
				<td><?php $qgc_out_order_zone_d=($qgc_d_tot-($qgc_d_booked+$qgc_d_standby)); echo ($qgc_d_tot-($qgc_d_booked+$qgc_d_standby));  ?></td>
				
				<td><?php $qgc_total_equip=$qgc_ab_tot+$qgc_c_tot+$qgc_d_tot ; echo $qgc_ab_tot+$qgc_c_tot+$qgc_d_tot ;  ?></td>
				<!--td><?php echo $qgc_ab_booked+$qgc_c_booked+$qgc_d_booked;  ?></td-->
				<td><?php echo $qgc_d_booked;  ?></td>
				<td><?php $qgc_stand_by=$qgc_ab_standby+$qgc_c_standby+$qgc_d_standby; echo $qgc_ab_standby+$qgc_c_standby+$qgc_d_standby;  ?></td>
				<!--td><?php echo $qgc_ab_out+$qgc_c_out+$qgc_d_out;  ?></td-->
				<td><?php $qgc_out_of_order=$qgc_ab_out+$qgc_c_out+($qgc_d_tot-($qgc_d_booked+$qgc_d_standby)); echo $qgc_ab_out+$qgc_c_out+($qgc_d_tot-($qgc_d_booked+$qgc_d_standby));  ?></td>
			...
			while($rtnRTGQuery=mysql_fetch_object($rowRTGQry))
			{
				...
				if($rtg_c_standby<0)
				{
					$rtg_c_standby=2; // Default 2 Stand By
				}
				if($rtg_d_standby<0)
				{
					$rtg_d_standby=0;
			...
			<tr align="center">			
				...
				<td><?php $rtg_out_order_zone_d=($rtg_d_tot-($rtg_d_booked+$rtg_d_standby)); echo ($rtg_d_tot-($rtg_d_booked+$rtg_d_standby));  ?></td>
				
				<td><?php $rtg_total_equip = $rtg_ab_tot+$rtg_c_tot+$rtg_d_tot ; echo $rtg_ab_tot+$rtg_c_tot+$rtg_d_tot ;  ?></td>
				<td><?php $rtg_total_booked=$rtg_ab_booked+$rtg_c_booked+$rtg_d_booked; echo $rtg_ab_booked+$rtg_c_booked+$rtg_d_booked;  ?></td>
				<td><?php $rtg_stand_by = $rtg_ab_standby+$rtg_c_standby+$rtg_d_standby; echo $rtg_ab_standby+$rtg_c_standby+$rtg_d_standby;  ?></td>
				<!--td><?php echo $rtg_ab_out+$rtg_c_out+$rtg_d_out;  ?></td-->
				<td><?php $rtg_out_of_order = $rtg_ab_out+$rtg_c_out+($rtg_d_tot-($rtg_d_booked+$rtg_d_standby)); echo $rtg_ab_out+$rtg_c_out+($rtg_d_tot-($rtg_d_booked+$rtg_d_standby));  ?></td>
			...
			<tr align="center">			
				...
				<td><?php $mhc_out_order_zone_d=($mhc_d_tot-($mhc_d_booked+$mhc_d_standby)); echo ($mhc_d_tot-($mhc_d_booked+$mhc_d_standby));  ?></td>
				
				<td><?php $mhc_total_equip=$mhc_ab_tot+$mhc_c_tot+$mhc_d_tot; echo $mhc_ab_tot+$mhc_c_tot+$mhc_d_tot;  ?></td>
				<td><?php $mhc_total_booked=$mhc_ab_booked+$mhc_c_booked+$mhc_d_booked; echo $mhc_ab_booked+$mhc_c_booked+$mhc_d_booked;  ?></td>
				<td><?php $mhc_stand_by=$mhc_ab_standby+$mhc_c_standby+$mhc_d_standby; echo $mhc_ab_standby+$mhc_c_standby+$mhc_d_standby;  ?></td> <!-- STAND BY -->
				<!--td><?php echo $mhc_ab_out+$mhc_c_out+$mhc_d_out;  ?></td-->
				<td><?php $mhc_out_of_order=$mhc_ab_out+$mhc_c_out+($mhc_d_tot-($mhc_d_booked+$mhc_d_standby)); echo $mhc_ab_out+$mhc_c_out+($mhc_d_tot-($mhc_d_booked+$mhc_d_standby));  ?></td>
			...
			<tr align="center">			
				...
				<td><?php $rmg_out_order_zone_d =($rmg_d_tot-($rmg_d_booked+$rmg_d_standby));   echo ($rmg_d_tot-($rmg_d_booked+$rmg_d_standby));  ?></td>
				
				<td><?php $rmg_total_equip = $rmg_ab_tot+$rmg_c_tot+$rmg_d_tot ; echo $rmg_ab_tot+$rmg_c_tot+$rmg_d_tot ;  ?></td>
				<td><?php $rmg_total_booked=$rmg_ab_booked+$rmg_c_booked+$rmg_d_booked;  echo $rmg_ab_booked+$rmg_c_booked+$rmg_d_booked;  ?></td>
				<td><?php $rmg_stand_by=$rmg_ab_standby+$rmg_c_standby+$rmg_d_standby;  echo $rmg_ab_standby+$rmg_c_standby+$rmg_d_standby;  ?></td>
				<!--td><?php echo $rmg_ab_out+$rmg_c_out+$rmg_d_out;  ?></td-->
				<td><?php $rmg_out_of_order= $rmg_ab_out+$rmg_c_out+($rmg_d_tot-($rmg_d_booked+$rmg_d_standby)); echo $rmg_ab_out+$rmg_c_out+($rmg_d_tot-($rmg_d_booked+$rmg_d_standby));  ?></td>
			...
			<tr align="center">			
				...
				<td><?php $sc_ab_booked_s=$sc_ab_booked;  echo $sc_ab_booked;  ?></td>
				<td><?php $sc_ab_standby_s=$sc_ab_standby; echo $sc_ab_standby;  ?></td> <!-- STAND BY -->
				<td><?php $sc_ab_out_s=$sc_ab_out; echo $sc_ab_out;  ?></td>
				
				<td><?php $sc_c_tot_s=$sc_c_tot;  echo $sc_c_tot;  ?></td>
				<td><?php $sc_c_booked_s=$sc_c_booked;  echo $sc_c_booked;  ?></td>
				<td><?php $sc_c_standby_s=$sc_c_standby; echo $sc_c_standby;  ?></td> <!-- STAND BY -->
				<td><?php $sc_c_out_s=$sc_c_out;  echo $sc_c_out;  ?></td>
				
				<td><?php $sc_d_tot_s=$sc_d_tot; echo $sc_d_tot;  ?></td>
				<td><?php $sc_d_booked_s=$sc_d_booked; echo $sc_d_booked;  ?></td>
				<td><?php $sc_d_standby_s=$sc_d_standby; echo $sc_d_standby;  ?></td> <!-- STAND BY -->
				<td><?php $sc_out_order_zone_d=$sc_d_out; echo $sc_d_out;  ?></td>
				
				<td><?php $sc_total_equip=$sc_ab_tot+$sc_c_tot+$sc_d_tot ;  echo $sc_ab_tot+$sc_c_tot+$sc_d_tot ;  ?></td>
				<td><?php $sc_total_booked= $sc_ab_booked+$sc_c_booked+$sc_d_booked; echo $sc_ab_booked+$sc_c_booked+$sc_d_booked;  ?></td>
				<td><?php $sc_stand_by=$sc_ab_standby+$sc_c_standby+$sc_d_standby; echo $sc_ab_standby+$sc_c_standby+$sc_d_standby;  ?></td>
				<td><?php $sc_out_of_order=$sc_ab_out+$sc_c_out+$sc_d_out; echo $sc_ab_out+$sc_c_out+$sc_d_out;  ?></td>
			...
			<tr align="center">			
				...
				<td><?php $rst45_ab_booked=$sc_ab_booked; echo $sc_ab_booked;  ?></td>
				<td><?php $rst45_ab_standby=$sc_ab_standby; echo $sc_ab_standby;  ?></td> <!-- STAND BY -->
				<td><?php $rst45_ab_out=$sc_ab_out;  echo $sc_ab_out;  ?></td>
				
				<td><?php $rst45_c_tot=$sc_c_tot; echo $sc_c_tot;  ?></td>
				<td><?php $rst45_c_booked=$sc_c_booked; echo $sc_c_booked;  ?></td>
				<td><?php $rst45_c_standby=$sc_c_standby; echo $sc_c_standby;  ?></td> <!-- STAND BY -->
				<td><?php $rst45_c_out=$sc_c_out; echo $sc_c_out;  ?></td>
				...
				<td><?php $rst45_total_equip = $sc_ab_tot+$sc_c_tot ; echo $sc_ab_tot+$sc_c_tot ;  ?></td>
			...
			<tr align="center">			
				...
				<td><?php $flt7_ab_booked=$sc_ab_booked;  echo $sc_ab_booked;  ?></td>
				<td><?php $flt7_ab_standby=$sc_ab_standby; echo $sc_ab_standby;  ?></td> <!-- STAND BY -->
				<td><?php $flt7_ab_out=$sc_ab_out; echo $sc_ab_out;  ?></td>
				
				<td><?php $flt7_c_tot=$sc_c_tot; echo $sc_c_tot;  ?></td>
				<td><?php $flt7_c_booked=$sc_c_booked; echo $sc_c_booked;  ?></td>
				<td><?php $flt7_c_standby=$sc_c_standby; echo $sc_c_standby;  ?></td> <!-- STAND BY -->
				<td><?php $flt7_c_out=$sc_c_out; echo $sc_c_out;  ?></td>
				...
				<td><?php $flt7_total_equip=$sc_ab_tot+$sc_c_tot ; echo $sc_ab_tot+$sc_c_tot ;  ?></td>
			...
			<tr align="center">			
				...
				<td><?php $rst7_ab_booked=$sc_ab_booked; echo $sc_ab_booked;  ?></td>
				<td><?php $rst7_ab_standby=$sc_ab_standby; echo $sc_ab_standby;  ?></td> <!-- STAND BY -->
				<td><?php $rst7_ab_out=$sc_ab_out; echo $sc_ab_out;  ?></td>
				
				<td><?php $rst7_c_tot=$sc_c_tot; echo $sc_c_tot;  ?></td>
				<td><?php $rst7_c_booked=$sc_c_booked; echo $sc_c_booked;  ?></td>
				<td><?php $rst7_c_standby=$sc_c_standby; echo $sc_c_standby;  ?></td> <!-- STAND BY -->
				<td><?php $rst7_c_out=$sc_c_out; echo $sc_c_out;  ?></td>
				
				<td><?php $rst7_d_tot= $sc_d_tot; echo $sc_d_tot;  ?></td>
				<td><?php $rst7_d_booked=$sc_d_booked;  echo $sc_d_booked;  ?></td>
				<td><?php $rst7_d_standby=$sc_d_standby; echo $sc_d_standby;  ?></td> <!-- STAND BY -->
				<td><?php $rst7_out_order_zone_d= $sc_d_out; echo $sc_d_out;  ?></td>
				
				<td><?php $rst7_total_equip = $sc_ab_tot+$sc_c_tot+$sc_d_tot; echo $sc_ab_tot+$sc_c_tot+$sc_d_tot;  ?></td>
				<td><?php $rst7_total_booked=$sc_ab_booked+$sc_c_booked+$sc_d_booked;  echo $sc_ab_booked+$sc_c_booked+$sc_d_booked;  ?></td>
				<td><?php $rst7_stand_by=$sc_ab_standby+$sc_c_standby+$sc_d_standby;  echo $sc_ab_standby+$sc_c_standby+$sc_d_standby;  ?></td>
			...
			<tr align="center">			
				...
				<td><?php $cm_total_equip=$cm_ab_tot+$cm_c_tot ;  echo $cm_ab_tot+$cm_c_tot ;  ?></td>
			...
			<tr align="center">		
				...
				<th><?php echo $qgc_out_order_zone_d + $rtg_out_order_zone_d + $mhc_out_order_zone_d + $rmg_out_order_zone_d + $sc_out_order_zone_d + $rst7_out_order_zone_d; ?></th>
				<th><?php echo $qgc_total_equip + $rtg_total_equip + $mhc_total_equip + $rmg_total_equip + $sc_total_equip + $rst45_total_equip + $flt7_total_equip + $rst7_total_equip + $cm_total_equip;  ?></th>
